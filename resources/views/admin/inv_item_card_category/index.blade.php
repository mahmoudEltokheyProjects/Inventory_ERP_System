...
{{-- ++++++++ tab_title ++++++++ --}}
@section('tab_title')فئات الاصناف@endsection
{{-- ++++++++ header ++++++++ --}}
@section('contentHeader')
فئات الاصناف &nbsp; <i class="fa fa-boxes"></i>
@endsection
{{-- ++++++++ header link ++++++++ --}}
@section('contentHeaderLink')
    <a href="{{ route('inv_item_card_categories.index') }}">عرض</a>
@endsection
{{-- ++++++++ active link ++++++++ --}}
@section('contentHeaderActiveLink')فئات الاصناف@endsection
{{-- ++++++++ content ++++++++ --}}
@section('content')
    <div class="row">
        {{-- =========== Content =========== --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="text-center">بيانات فئات للأصناف</h5>
                    {{-- ++++++++++++++++ Create Button ++++++++++++++++ --}}
                    <a href="{{ route('inv_item_card_categories.create') }}" class="btn btn-primary btn-md">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody class="all_data">
                                    @foreach ($data as $index => $info )
                                            ...
                                            <td class="dropdown show">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu" x-placement="bottom-end" style="position: absolute; transform: translate3d(73px, 31px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                        {{-- +++++++++ Show Button +++++++++ --}}
                                                        <li>
                                                            <a href="{{ route('inv_item_card_categories.show',$info->id) }}" class="dropdown-item" target="_blank">
                                                        ...
                                                        <li>
                                                            {{-- +++++++++ Edit Button +++++++++ --}}
                                                            <a href="{{ route('inv_item_card_categories.edit',$info->id) }}" class="dropdown-item btn btn-sm  btn-primary" target="_blank">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a type="button" class="dropdown-item btn btn-sm  btn-danger"
                                                                data-toggle="modal"
                                                                data-target="#delete_inv_item{{ $info->id }}" title="حذف">
                                        ...
                                        {{-- ++++++++++++ Delete Modal +++++++++++ --}}
                                        @include('admin.inv_item_card_category.partials.delete_modal')
                                    @endforeach
                                </tbody>
                            </table>
                            {{-- ++++++++++++ Laravel Pagination +++++++++++ --}}
