...
{{-- ++++++++ title ++++++++ --}}
@section('title')تفاصيل حسابات الموردين@endsection
{{-- ++++++++ tab_title ++++++++ --}}
@section('tab_title')فئات الموردين@endsection
{{-- ++++++++ header ++++++++ --}}
@section('contentHeader')
تفاصيل حسابات الموردين <i class="fa fa-truck-ramp-box"></i>
@endsection
{{-- ++++++++ header link ++++++++ --}}
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    {{-- ++++++++++ Edit Button ++++++++++ --}}
                                    <a href="{{ route('admin.suppliers_categories.edit', $data['id']) }}" class="btn btn-sm btn-success">تعديل</a>
                                    {{-- ++++++++++ Back Button ++++++++++ --}}
                                    <a href="{{ route('admin.suppliers_categories.index') }}" class="btn btn-sm btn-info">عودة</a>
