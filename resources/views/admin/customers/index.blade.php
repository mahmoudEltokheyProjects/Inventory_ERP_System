...
{{-- ++++++++ tab_title ++++++++ --}}
@section('tab_title')العملاء@endsection
{{-- ++++++++ header ++++++++ --}}
    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="text-center mb-5">بيانات العملاء</h5>
                {{-- ++++++++++++++++++++++++++ Search ++++++++++++++++++++++++++ --}}
                <div class="col-12 mb-2">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            {{-- "customer_code" radionButton --}}
                            <input type="radio" name="search_by_text_radio" id="search_by_customer_code_radio" value="customer_code">
                            <label for="search_by_customer_code_radio" style="font-weight:normal;">كود العميل</label>
                            {{-- -------- search inputField -------- --}}
                            <input type="text" id="search_by_text" placeholder="اسم - رقم الحساب - كود العميل" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <td class="dropdown show">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu" x-placement="bottom-end" style="position: absolute; transform: translate3d(73px, 31px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                    {{-- +++++++++ Show Button +++++++++ --}}
                                                    <li>
                                                        <a href="{{ route('customers.show',$info->id) }}" class="dropdown-item" target="_blank">
                                                    ...
                                                    <li>
                                                        {{-- +++++++++ Edit Button +++++++++ --}}
                                                        <a href="{{ route('customers.edit',$info->id) }}" class="dropdown-item btn btn-sm  btn-primary" target="_blank">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a type="button" class="dropdown-item btn btn-sm  btn-danger"
                                                            data-toggle="modal"
                                                            data-target="#delete_customer{{ $info->id }}" title="حذف">
